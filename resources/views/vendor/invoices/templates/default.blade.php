            ...
            <tbody>
                <tr>
                    <td class="px-0">
                        ...
                        <p class="seller-registru-comert">
                            <strong>Regsitrul comerțului:</strong> J1/724/1992 
                        </p>

                        <p class="seller-cod-fiscal">
                            <strong>Cod fiscal:</strong> RO1754002
                        </p>

                        <p class="seller-cap-social">
                            <strong>Capital social:</strong> 200 RON
                        </p>

                        <p class="seller-sediu">
                            <strong>Sediu:</strong> Str. Cuza Voda 12, Aiud, Alba
                        </p>
                        ...
                        <!-- @if($invoice->seller->code)
                            <p class="seller-code">
                                <strong>CUI:</strong> 1754002
                            </p>
                        @endif

                        @if($invoice->seller->vat)
                            <p class="seller-vat">
                                Nr. înmatriculare: J01/724/1992
                            </p>
                        @endif
                    ...
                    <td class="px-0">
                        @if($invoice->buyer->name)
                            <p class="buyer-name">
                                <strong>Nume:</strong> {{ $invoice->buyer->name }}
                            </p>
                        @endif
                        ...
                        @if($invoice->buyer->phone)
                            <p class="buyer-phone">
                                <strong>Telefon:</strong> {{ $invoice->buyer->phone }}
                            </p>
                        @endif
                        @if($invoice->buyer->address)
                            <p class="buyer-address">
                                <strong>Adresa:</strong> {{ $invoice->buyer->address }}, {{ $invoice->buyer->city }}, {{ $invoice->buyer->county }}, {{ $invoice->buyer->zipcode }}
                            </p>
                        @endif
